...
function playPrevious() {
    ...
    switch (playMode) {
        ...
        case 1: // 顺序播放
            ...
            break;
        default: // 单曲循环
            newIndex = currentMusicIndex;  // 索引不变
            break;
    }
...
function playNext() {
    ...
    switch (playMode) {
        case 2: // 随机播放
            ...
            break;
        case 1: //  顺序播放- 修正为正确的单曲循环逻辑
            newIndex = currentMusicIndex + 1;  // ✅ 播放下一首
            if (newIndex >= musicList.length) newIndex = 0;
            break;
        default: //  单曲循环- 修正为正确的顺序播放逻辑
            newIndex = currentMusicIndex;  // ✅ 索引不变，实现单曲循环
            break;
    }
